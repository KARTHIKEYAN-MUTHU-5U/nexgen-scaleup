  ...
  return (
    <>
      <motion.nav
        ...
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? 'bg-[#0a0a0a]/90 backdrop-blur-xl border-b border-white/5 py-4' : 'bg-transparent py-6'}`}
      >
        <div className="max-w-6xl mx-auto px-6 md:px-12 flex justify-between items-center">
          ...
          <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="hidden md:flex px-6 py-2.5 bg-[#25D366] text-white font-semibold text-xs uppercase tracking-wider hover:bg-[#1da851] transition-colors items-center gap-2 clip-diagonal">
...
function Hero() {
  return (
    <section className="relative min-h-[100vh] flex items-center pt-24 pb-16 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 w-full z-10">
        <div className="flex flex-col items-start gap-6">
          ...
          <div className="max-w-5xl">
            <motion.h1
              ...
              className="font-display text-[2.8rem] sm:text-[4.5rem] md:text-[6rem] lg:text-[7.5rem] font-bold leading-[0.85] tracking-tighter uppercase mb-4"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {quickServices.map((s, i) => (
            <motion.a
              ...
              className="group bg-[#0a0a0a] p-5 clip-diagonal hover:bg-[#111] hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-white/5 hover:border-amber-500/20"
            >
    ...
    <section id="services" className="py-32 bg-[#0a0a0a]">
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {personalDocs.map((doc, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="group bg-black/50 p-9 clip-diagonal hover:bg-white/[0.06] hover:-translate-y-1 transition-all duration-300 border border-white/[0.08] hover:border-amber-500/20"
              >
          ...
          <div className="mt-10 bg-black/50 p-9 clip-diagonal">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {businessRegs.map((reg, i) => (
              <motion.a
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="group bg-amber-500 text-black p-9 clip-diagonal hover:bg-amber-400 transition-all cursor-pointer"
              >
...
function HowItWorks() {
  return (
    <section id="how-it-works" className="py-36 bg-black border-y border-white/10 overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        <motion.h2
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, i) => (
            <motion.div
              ...
              className="relative bg-[#0a0a0a] p-10 clip-diagonal"
            >
...
function TrustSection() {
  return (
    <section className="py-36 bg-[#0a0a0a]">
      <div className="max-w-6xl mx-auto px-6 md:px-12 text-center">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="font-display text-4xl md:text-7xl font-bold tracking-tighter uppercase leading-[0.85] mb-8">
            <span className="block text-white">WHY PEOPLE</span>
            <span className="block" style={{ WebkitTextStroke: '2px rgba(255,255,255,0.5)', color: 'transparent' }}>TRUST US</span>
          </h2>
          <p className="text-[#a3a3a3] text-lg max-w-2xl mx-auto mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((b, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: i * 0.1 }}
              className="bg-black/50 p-10 text-left clip-diagonal border border-white/[0.08] hover:border-amber-500/20 hover:-translate-y-1 transition-all duration-300"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-24 border-t border-white/10 pt-20 max-w-4xl mx-auto">
          {[
            ...
            <div key={i} className="flex flex-col items-center">
              <div className="font-mono text-4xl md:text-5xl text-amber-500 font-bold mb-2" style={{ fontFamily: "'JetBrains Mono', monospace" }}>{stat.metric}</div>
...
function FAQ() {
  ...
  return (
    <section id="faq" className="py-36 bg-black border-t border-white/10">
      <div className="max-w-4xl mx-auto px-6 md:px-12">
        ...
        <div className="space-y-4">
          {faqs.map((faq, i) => (
            ...
            >
              <button onClick={() => setOpen(open === i ? null : i)} className="w-full flex items-center justify-between p-7 text-left cursor-pointer group">
...
function Contact() {
  return (
    <section id="contact" className="py-36 bg-[#0a0a0a]">
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        <div className="bg-[#050505] p-10 md:p-20 clip-diagonal relative overflow-hidden">
    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed bottom-24 right-6 z-50 w-12 h-12 bg-amber-500 text-black flex items-center justify-center clip-diagonal hover:bg-amber-400 transition-colors cursor-pointer shadow-lg shadow-amber-500/20"
